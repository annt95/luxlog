...
mixin _$CategoryModel {
  ...
  String get status =>
      throw _privateConstructorUsedError; // 'approved', 'pending', 'rejected'
  @JsonKey(name: 'suggested_by')
...
class _$CategoryModelImpl implements _CategoryModel {
  const _$CategoryModelImpl({
    ...
    @JsonKey(name: 'suggested_by') this.suggestedBy,
  ...
  @override
  String toString() {
    return 'CategoryModel(id: $id, name: $name, slug: $slug, icon: $icon, coverImage: $coverImage, displayOrder: $displayOrder, status: $status, suggestedBy: $suggestedBy, createdAt: $createdAt)';
  }
...
abstract class _CategoryModel implements CategoryModel {
  const factory _CategoryModel({
    ...
    final String status,
    @JsonKey(name: 'suggested_by') final String? suggestedBy,
  ...
  @override
  String get status; // 'approved', 'pending', 'rejected'
  @override
  @JsonKey(name: 'suggested_by')
