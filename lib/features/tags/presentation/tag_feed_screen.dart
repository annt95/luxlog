...
class TagFeedScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Mock data — will be replaced with TagRepository.getPhotosByTag()
    final mockPhotos = List.generate(18, (i) => (
      id: 'tag_photo_$i',
      url: 'https://picsum.photos/seed/${tagName}_$i/400/${400 + (i % 3) * 80}',
      likes: 50 + i * 12,
    ));
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${mockPhotos.length * 47} photos · Trending',
