...
String _$userRepositoryHash() => r'65630ff497066dc00b596b47d62f66e2182c497a';
...
String _$userProfileHash() => r'b246aff137c5d6c65b01b9fbb5ed42a4d12306b6';
...
/// See also [userProfile].
class UserProfileFamily extends Family<AsyncValue<Map<String, dynamic>>> {
  /// See also [userProfile].
  const UserProfileFamily();

  /// See also [userProfile].
  UserProfileProvider call(String username) {
    return UserProfileProvider(username);
  }
...
class UserProfileProvider
  ...
  /// See also [userProfile].
  UserProfileProvider(String username)
    : this._internal(
        (ref) => userProfile(ref as UserProfileRef, username),
  ...
  Override overrideWith(
    FutureOr<Map<String, dynamic>> Function(UserProfileRef provider) create,
  ) {
  ...
  bool operator ==(Object other) {
    return other is UserProfileProvider && other.username == username;
  }
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
mixin UserProfileRef on AutoDisposeFutureProviderRef<Map<String, dynamic>> {
